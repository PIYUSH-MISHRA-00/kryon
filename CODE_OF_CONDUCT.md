...
community leaders responsible for enforcement at **piyushmishra.professional@gmail.com**.
All complaints will be reviewed and investigated promptly and fairly.

All community leaders are obligated to respect the privacy and security of the reporter of
any incident.

> **A note on this project's size.** Kryon currently has one maintainer, who is also the
> person receiving reports. If your report concerns that maintainer's own conduct, raising it
> publicly in an [issue](https://github.com/PIYUSH-MISHRA-00/kryon/issues) or
> [discussion](https://github.com/PIYUSH-MISHRA-00/kryon/discussions) is legitimate and
> appropriate — there it cannot quietly be dropped. See [`GOVERNANCE.md`](GOVERNANCE.md).
